...
This guide demonstrates how to deploy ArgoCD on an Azure Kubernetes Service (AKS) cluster using the Bitnami ArgoCD Helm chart and includes instructions for basic usage.
...
> [!NOTE]
> `dex.config` is the key of the object.
